...
module ::AccountSecurity
  module Statistics
    ...
    COUNTERS = %i[assessments registrations logins manual_lookups auth_abuse_clusters correlation_candidates correlation_scans provider_calls cache_hits local_blacklist_hits tor_hits quota_skips provider_errors events_created notifications_sent].freeze
